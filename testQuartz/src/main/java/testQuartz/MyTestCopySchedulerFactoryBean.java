 ...
 */
public class MyTestCopySchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>,
	...
	public void afterPropertiesSetSlave() throws Exception {
...
//		
//		// (2) 创建Job
//		JobDetail jobDetail = JobBuilder.newJob(MyJob.class).withIdentity(MyJob2.class.getSimpleName(), MyJob2.class.getSimpleName()).storeDurably().build();
//		
		JobDetailImpl jdi = new JobDetailImpl();
		jdi.setName("AAAA");
		jdi.setGroup("AAAA");
		jdi.setJobClass((Class) MyJob2.class);
		jdi.setDurability(true);
		jdi.getJobDataMap().put("AAAA", this);
		
		// (3) 创建触发器
		CronScheduleBuilder scheduleBuilder = CronScheduleBuilder.cronSchedule("*/5 * * * * ?");
		Trigger trigger = TriggerBuilder.newTrigger().forJob(jdi.getKey()).withIdentity(MyJob2.class.getSimpleName(), MyJob2.class.getSimpleName()).withSchedule(scheduleBuilder).build();
